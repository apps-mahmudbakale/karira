...
import { useIndividualSignupMutation } from "../../services/auth/login";
import AuthLeft from "../business/shared/AuthLeft";
...
const IndividualSignUp = () => {
  ...
  const [signup, { isLoading: isSubmitting }] = useIndividualSignupMutation();
