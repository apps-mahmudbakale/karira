...
const ReceiversInfo = ({ formik }: Props) => {
  return (
    <div>
      <div className="w-full max-w-[537px] p-5 space-y-5 mt-8  md:space-y-[34px] ">
        <div className="w-full">
          <div className="w-full max-w-[537px] mt-4 flex flex-col gap-y-5 md:mt-8 md:gap-y-[34px]">
            ...
            <div className="flex w-full flex-col gap-y-[10px]">
              ...
              <PhoneNumber formik={formik} fieldName="receiver_phone" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-y-[8px]">
          <label htmlFor="drop_location" className="text-[#333]">
            Drop off Location<span className="text-[#F04438]">*</span>
          </label>
          <div className="w-full relative">
            ...
            <div className="w-full">
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  ...
                  className=" text-deepBlack font-fellix-regular w-full"
