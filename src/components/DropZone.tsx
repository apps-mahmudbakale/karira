...
const DropZone = ({ formik, field_name, file_name }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-y-[8px]">
      <label
        htmlFor="video_image"
        className="text-deepBlack text-base font-fellix-regular"
      >
        Upload short video/image<span className="text-[#F04438]">*</span>
      </label>
                  ...
                  {formik.values[file_name] ? (
                    <>
                      ...
                      <p className="text-grey-00 font-fellix-regular text-xs">
                        File name: {formik.values[file_name].name}
                      </p>
                      {formik.values[file_name].type.startsWith("image/") && (
                        <img
                          ...
                          className="mt-2 w-full max-w-[300px] rounded-md h-full object-center object-cover max-h-[200px]"
                        />
                      )}
                      <button
                        type="button"
